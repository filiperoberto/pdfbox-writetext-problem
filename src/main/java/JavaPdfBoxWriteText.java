...
public class JavaPdfBoxWriteText {
    ...
    public static void main(String[] args) throws IOException {
        ...
        InputStream is = classloader.getResourceAsStream("scansmpl.pdf");

        try (PDDocument doc = PDDocument.load(is)) {

            PDPage myPage = doc.getPage(0);

            try (PDPageContentStream cont = new PDPageContentStream(doc, myPage, PDPageContentStream.AppendMode.PREPEND, true)) {
